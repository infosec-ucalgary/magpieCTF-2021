...
# NOTE: I didn't write this all myself. I borrowed it and changed some stuff up.
# I'm pretty sure I got this from this gist:
...
D = DomainName('magpie.flag.')
IP = '34.219.182.220'
TTL = 60 * 5

soa_record = SOA(
    mname=D.ns1,  # primary name server
    rname=D.flag,  # email of the domain administrator
    times=(
